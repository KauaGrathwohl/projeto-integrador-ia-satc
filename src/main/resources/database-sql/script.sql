...
CREATE TABLE PLANOS_METAS (
    ...
    QTD_DIARIA_CALORIAS         NUMERIC(10,2) NOT NULL,
    QTD_DIARIA_PROTEINAS        NUMERIC(10,2) NOT NULL,
    QTD_DIARIA_CARBOIDRATOS     NUMERIC(10,2) NOT NULL,
    QTD_DIARIA_GORDURA          NUMERIC(10,2) NOT NULL,
...
CREATE TABLE PLANOS_METAS_REFEICOES (
    ...
    QTD_CALORIAS_REFEICAO       NUMERIC(10,2) NOT NULL,
    QTD_PROTEINAS_REFEICAO      NUMERIC(10,2) NOT NULL,
    QTD_CARBOIDRATOS_REFEICAO   NUMERIC(10,2) NOT NULL,
    QTD_GORDURA_REFEICAO        NUMERIC(10,2) NOT NULL,
...
CREATE TABLE PLANOS_METAS_REFEICOES_RECEITAS (
    ...
    DESCRICAO                   VARCHAR(1000) NOT NULL,
    QTD_CALORIS_RECEITA         NUMERIC(10,2) NOT NULL,
    QTD_PROTEINAS_RECEITA       NUMERIC(10,2) NOT NULL,
    QTD_CARBOIDRATOS_RECEITA    NUMERIC(10,2) NOT NULL,
    QTD_GORDURA_RECEITA         NUMERIC(10,2) NOT NULL,
    QTD_GRAMAS_RECEITA          NUMERIC(10,2) NOT NULL,
    TIPO_REFEICAO               INTEGER NOT NULL,
