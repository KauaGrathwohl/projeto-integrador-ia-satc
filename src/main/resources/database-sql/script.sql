...
CREATE SEQUENCE SEQ_ENTIDADES START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE;
...
CREATE SEQUENCE SEQ_USUARIOS START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE;
...
CREATE SEQUENCE SEQ_CONFIGURACOES_GERAIS START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE;
...
CREATE TABLE USUARIOS_ENTIDADES (
    ...
    ID_USUARIOS       NUMERIC(19) NOT NULL,
    PRIMARY KEY (ID_ENTIDADES, ID_USUARIOS)
);
...
CREATE SEQUENCE SEQ_PACIENTES START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE;
...
CREATE SEQUENCE SEQ_PLANOS_METAS START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE;
...
CREATE SEQUENCE SEQ_PLANOS_METAS_REFEICOES START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE;
...
CREATE SEQUENCE SEQ_RECEITAS START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE;
...
CREATE TABLE PLANOS_METAS_REFEICOES_RECEITAS (
    ...
    TIPO_REFEICAO               INTEGER NOT NULL,
    CONSTRAINT PK_PLANOS_METAS_REFEICOES_RECEITAS PRIMARY KEY (ID)
);
CREATE SEQUENCE SEQ_PLANOS_METAS_REFEICOES_RECEITAS START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE;
...
CREATE SEQUENCE SEQ_ROLES START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE;

CREATE TABLE USUARIOS_ROLES (
    ROLE_ID                     NUMERIC(19) NOT NULL,
    USUARIO_ID                  NUMERIC(19) NOT NULL
);
ALTER TABLE USUARIOS_ROLES ADD CONSTRAINT FK_USUARIOS_ROLES_ROLES FOREIGN KEY (ROLE_ID) REFERENCES ROLES(ID);
ALTER TABLE USUARIOS_ROLES ADD CONSTRAINT FK_USUARIOS_ROLES_USUARIOS FOREIGN KEY (USUARIO_ID) REFERENCES USUARIOS(ID);